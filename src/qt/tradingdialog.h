...
private slots:
    ...
    QString BuyLEE(QString OrderType, double Quantity, double Rate);
    QString SellLEE(QString OrderType, double Quantity, double Rate);
